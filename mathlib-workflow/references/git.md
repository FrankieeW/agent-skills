...
__You only ever need to do this step once.__
...
__Do this before creating a new branch__ to ensure you're working with the latest changes:
...
1. Check out the relevant PR branch by running `git switch <pr-branch-name>` if this is your own PR, or by following the instructions in the section `Working with Others' PRs` below if you intend to work on top of someone else's PR.
...
Please check the Security Warning in the Additional Information section.
...
3. Click "Collaborators" (you may have to reauthenticate)
4. Enter their GitHub username
5. Choose "Write" permission level
...
__Important__: When you give someone collaborator access to your fork, or when you checkout and run someone else's code, you are potentially running unreviewed code on your computer. Only collaborate with people you trust, as they could potentially include malicious code that runs during the build process.
...
__Problem__: "Your branch is behind 'upstream/master'"
__Solution__:
...
__Problem__: "fatal: The current branch has no upstream branch"
__Solution__:
...
__Problem__: Accidentally committed to your copy of the master branch
__Solution__: Move the commits to a new branch:
